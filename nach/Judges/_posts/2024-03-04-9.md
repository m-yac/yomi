...
redirect_from: [/nach-2024/judges/9/]
---
...
<!--more-->
- The same online sources as above usually also claim that this tree-based story is sometimes told on {{ 'ט״ו בשבת' | he: 'tu bish’vat' }}, the Jewish agricultural New Year prescribed in the *Torah* – which in modern times has become sort of a Jewish Earth Day where people plant trees. But, I could not find a source which goes beyond just repeating the same one-sentence claim, and I've never heard of this tradition, so it may not be widespread or very old.
- The etymological connection between the word {{ 'משל' | he: 'mashal', 'parable' }} and the subject of the parable {{ 'מֹשֵל' | he: 'moshel', 'ruling' }}, is impossible for me to ignore. I can’t find anything which explains why these two words share the same root, but it’s interesting that they do. The latter word features repeatedly in {% my_notes_on Judges 8 %}.
